...
}})
{
    ...
    const {
      ...
      } = useFieldArray({ name: "availability", control: form.control })
                    ...
                    {/* Render availability entries for this day */}
                        {groupedAvailabilityFields[dayOfWeek]?.map(
                            ...
                            <div className="flex flex-col gap-1" key={field.id}>
                                ...
                                <FormField
                                    control={form.control}
                                    name={`availability.${field.index}.startTime`}
                                    render={({ field }) => (
                                    <FormItem>
                                        <FormControl>
                                        <Input
                                ...
                                <FormField
                                    control={form.control}
                                    name={`availability.${field.index}.endTime`}
                                    render={({ field }) => (
                                    <FormItem>
                                        <FormControl>
                                        <Input
                                ...
                                <FormMessage>
                                {
                                    form.formState.errors.availability?.at?.(
                                    field.index
                                    )?.root?.message
